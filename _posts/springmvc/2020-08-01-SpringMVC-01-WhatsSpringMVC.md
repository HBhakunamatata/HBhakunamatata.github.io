...
![model01](/assets/post-images/springmvc/model01.png)

- JSP的职能不唯一，负责前端页面展示和控制器(控制逻辑和表现逻辑)两种功能，不便于维护。

### 1.3 Model 2

![model02](/assets/post-images/springmvc/model02.webp)
...
![springmachenism](/assets/post-images/springmvc/springmachenism.png)